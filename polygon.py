...
tx_hash = contract.constructor('Hello, Polygon!').transact({'from': w3.eth.accounts[0]})
...
contract_instance.functions.setMessage('Hello, Matic!').transact({'from': w3.eth.accounts[0]})
